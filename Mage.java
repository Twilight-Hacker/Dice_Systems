...
/**
 * This program was writen as a Storytelling aid for 
 * the P&P R.P.G. Mage-The Acsension. In order to use
 * it correctly, one must know the rules of the game,
 * as described at the game's Basic Rulebook
 * 
 * Diamond Viper (your name) 
 * version 1.0 (6-7/12/2005)
 */
